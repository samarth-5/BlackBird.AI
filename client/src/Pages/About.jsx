  ...
  return (
    <section className='my-20 mx-[200px] full-screen-bg'>
      ...
      <div className='flex justify-between'>
        ...
        <Link target="_blank" to='https://samarth-fsdev.vercel.app/'><FaGlobe size={30} className='text-[#00ff31] mr-5' /></Link>
      </div>
      ...
      <div className=' px-5 py-3 flex gap-3 outline outline-slate-600 hover:outline-[#00ff31] rounded-3xl w-min'>
        <Link target="_blank" to='https://www.linkedin.com/in/samarth-narayan/' className='hover:scale-150 duration-500'><FaLinkedin size={25} className='hover:text-[#00ff31]' /></Link> 
